...
# For this module to be successful, we also need to remove the category that we are performing the binary transform on. Note that 'binary transform' means to transform the baseline category into a 0 and 1 for all other cases
