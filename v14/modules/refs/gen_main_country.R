...
# As inputs we use the coder table and the country_table. The main country is
# different from the V-Dem country structure. It is mainly used for the IRT
# measurement model to cluster expert-specific thresholds around their main
# country.  
...
# -- name from country are matched against country_name from coder
# -- country_id from country -> main_country_id for coder
out <- merge(
    x = res,
