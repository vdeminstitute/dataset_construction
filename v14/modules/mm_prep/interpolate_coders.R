...
#
# For a more specific description, look at the main function.
# 
# In its current form, this script requires a lot of working memory, do not 
# run more than 2-3 jobs at the same time.
# ==========================================================================
