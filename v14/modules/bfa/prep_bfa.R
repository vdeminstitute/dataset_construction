...
# for some indices that contain election-specific components, we need to stretch
...
main <- function(objs, comps, frassoc, bfa_script, country, utable, TASK_NAME, qtable, DRAWS) {
    ...
    # -- currently, they are not used to any computation
