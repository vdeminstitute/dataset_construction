use "~/data/ds_construction/v15/stata/structure_of_executives_input.dta", clear
...
save "~/data/ds_construction/v15/stata/structure_of_executives_output.dta", replace


*label var op_both_v70 "Ruling party"
*label var mil_both_v70 "Military"
*label var mon_both_v70 "Hereditary"
*label var elecexw "Direct election"
*label var leg_rule2 "Confidence"
