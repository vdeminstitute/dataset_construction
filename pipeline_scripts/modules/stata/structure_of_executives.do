use "~/data/ds_construction/v16/stata/structure_of_executives_input.dta", clear
...
save "~/data/ds_construction/v16/stata/structure_of_executives_output.dta", replace
