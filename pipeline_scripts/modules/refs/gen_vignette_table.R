...
# (2) Match historical and contemporary vignettes to the same question_id
# 	    where reasonable.
# (3) Merge vignettes for variables that have women/men versions (e.g. v2clacjstw and v2clacjstm)
#-------------------------------------------------------------------------------
